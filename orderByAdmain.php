...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <a class="navbar-brand" href="orderByAdmain.php">Home</a>
        <a class="nav-link" href="orderByAdmain.php">ManualOrder</a>
        ...
        <div class="ml-auto">
            ...
            <img src="images/<?php echo($userImage); ?>" alt="Admain"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 order-summary">
                ...
                <form action="http://localhost/php/phpProject/homeUser.php" method="POST" id="orderForm">
    ...
    <script src="homeUserAdmain.js"></script>
</body>
